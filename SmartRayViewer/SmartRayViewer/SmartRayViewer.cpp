...
// SmartRayViewer.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CSmartRayViewerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CSmartRayViewerApp 생성

CSmartRayViewerApp::CSmartRayViewerApp()
{
	// 다시 시작 관리자 지원
...
// 유일한 CSmartRayViewerApp 개체입니다.

CSmartRayViewerApp theApp;


// CSmartRayViewerApp 초기화

BOOL CSmartRayViewerApp::InitInstance()
{
